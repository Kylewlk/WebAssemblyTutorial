...
// This file is a part of WebIDL bindings test suite.
var TheModule = Module;
var isMemoryGrowthAllowed = false;
...
(async function main() {
  ...
  console.log(
    "add: " + new TheModule.Inner(1).add(new TheModule.Inner(2)).get_value()
  );
  ...
  console.log(
    [enumClassInstance.GetEnum(), TheModule.EnumClass.e_val].join(",")
  );
  ...
  console.log(
    "return unsigned char " + (typeTester.ReturnUnsignedCharMethod() & 255)
  );
  typeTester.AcceptUnsignedCharMethod((2 << 7) - 1);

  console.log(
    "return unsigned short " + (typeTester.ReturnUnsignedShortMethod() & 65535)
  );
  typeTester.AcceptUnsignedShortMethod((2 << 15) - 1);

  console.log(
    "return unsigned long " + (typeTester.ReturnUnsignedLongMethod() | 0)
  );
  ...
  console.log(
    "struct_array[0].attr1 == " + arrayClass.get_struct_array(0).get_attr1()
  );
  console.log(
    "struct_array[0].attr2 == " + arrayClass.get_struct_array(0).get_attr2()
  );
  console.log(
    "struct_array[7].attr1 == " + arrayClass.get_struct_array(7).get_attr1()
  );
  console.log(
    "struct_array[7].attr2 == " + arrayClass.get_struct_array(7).get_attr2()
  );
  ...
  console.log(
    "struct_ptr_array[0]->attr1 == " +
      arrayClass.get_struct_ptr_array(0).get_attr1()
  );
  console.log(
    "struct_ptr_array[0]->attr2 == " +
      arrayClass.get_struct_ptr_array(0).get_attr2()
  );
  ...
  const arrayDomStringResult = arrayTestObj.domStringTest(
    "I should match the member variable"
  );
  ...
  if (isMemoryGrowthAllowed) {
    ...
    if (intArray.length !== numCopiedEntries) {
      console.log(
        "ERROR: An array was not copied to HEAP32 after memory reallocation"
      );
    }
  }
